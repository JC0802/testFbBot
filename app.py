...
def makeWebhookResult(req):
    if req.get("queryResult").get("action") == "navigate function": 
        #return {}
   ...
   # parameters = result.get("parameters")
    ...
    #speech = "The interest rate of " + zone + " is " + str(cost[zone])
        ...
        return {
            ...
            "fulfillmentText": userlocation
            }
    elif req.get("queryResult").get("action") == "current location":
        if req.get("queryResult").get("parameters").get("navigate Bot").lower() == 'navigate bot':
